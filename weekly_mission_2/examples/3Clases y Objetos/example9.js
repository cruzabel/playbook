...
class Developer {
  ...
  const abelDev = new Developer("Abel", "js", ["NodeJS", "Python", "Java"])
  console.log(abelDev)
  ...
  const abelLaunchXDev = new LaunchXStudent("Abel", "js", ["NodeJS", "Python", "Java"])
  console.log(abelLaunchXDev)
  console.log(abelLaunchXDev.getName) // getter de la clase padre rehusada en la clase hija